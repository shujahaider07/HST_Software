...
namespace HST
{
    public partial class salaries : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            sql.Open();
            String qry = "insert into salaries values (@amount , @date, @purpose)";
        ...
        {
            SqlConnection sql = new SqlConnection(cs);
            string qry = "Update salaries set amount = '" + textBox1.Text + "' , date ='" + dateTimePicker2.Value + "' where id = '" + textBox3.Text + "'";
            sql.Open();
            SqlCommand cmd = new SqlCommand(qry, sql);
            int a = cmd.ExecuteNonQuery();
            if (a > 0)
        ...
        {
            SqlConnection sql = new SqlConnection(cs);
            String qry = "delete from salaries where id = '" + textBox3.Text + "'";
            sql.Open();
            SqlCommand cmd = new SqlCommand(qry, sql);
            int a = cmd.ExecuteNonQuery();
            if (a > 0)
        ...
        {
            SqlConnection sql = new SqlConnection(cs);
            String qry = "Select * from salaries ";
        ...
        private void salaries_Activated(object sender, EventArgs e)
        {
            BindGridViewRent();
        }
        ...
        private void dateTimePicker3_CloseUp(object sender, EventArgs e)
        {
            ...
            if (fromDate <= toDate)
            {
                ...
                String qry = "Select * from salaries where date between '" + dateTimePicker2.Value + "' and '" + dateTimePicker3.Value + "' ";
                SqlCommand cmd = new SqlCommand(qry, sql);
                sql.Open();

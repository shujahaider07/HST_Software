...
namespace HST
{
    public partial class VoipView : Form
    {
        public VoipView()
        {
            InitializeComponent();
        ...
        private void VoipView_Load(object sender, EventArgs e)
        {
...

            {
                ...
                if (dataGridView1.Rows.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        saveFileDialoge.FileName = "VoipCost";
        ...
        private void dateTimePicker3_CloseUp(object sender, EventArgs e)
        {
            ...
            if (fromDate <= toDate)
            {
                ...
                String qry = "Select * from expenses where purpose = 'voip' and date between '" + dateTimePicker2.Value + "' and '" + dateTimePicker3.Value + "' ";
